...
public final class FragmentNotificationsBinding implements ViewBinding {
  ...
  private FragmentNotificationsBinding(@NonNull ConstraintLayout rootView,
      @NonNull ListView idListView, @NonNull TextView textNotifications) {
  ...
  public static FragmentNotificationsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.idListView;
      ListView idListView = ViewBindings.findChildViewById(rootView, id);
      if (idListView == null) {
        break missingId;
      }
      ...
      return new FragmentNotificationsBinding((ConstraintLayout) rootView, idListView,
          textNotifications);
    }
