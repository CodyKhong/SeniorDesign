...
public final class ActivityAdminDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final Button TempReqbutton;
  ...
  private ActivityAdminDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button TempReqbutton, @NonNull Button button8, @NonNull Button connectButton,
      @NonNull Button disconnectButton, @NonNull TextView logView, @NonNull Button switchButton,
      @NonNull TextView textView10) {
    this.rootView = rootView;
    this.TempReqbutton = TempReqbutton;
  ...
  public static ActivityAdminDashboardBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.TempReqbutton;
      Button TempReqbutton = ViewBindings.findChildViewById(rootView, id);
      if (TempReqbutton == null) {
        break missingId;
      }
      ...
      return new ActivityAdminDashboardBinding((ConstraintLayout) rootView, TempReqbutton, button8,
          connectButton, disconnectButton, logView, switchButton, textView10);
    }
