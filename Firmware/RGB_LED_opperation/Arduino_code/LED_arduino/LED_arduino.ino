...
RgbColor mosque1(0, 51, 51);
RgbColor mosque2(0, 204, 204);
RgbColor purple(200, 80, 128);
...
HslColor hslMosque1(mosque1);
HslColor hslMosque2(mosque2);
...
void loop()
{
    ...
    // set the colors, 
    // if they don't match in order, you need to use NeoGrbFeature feature
    strip.SetPixelColor(0, mosque2);
    strip.SetPixelColor(1, mosque2);
    strip.SetPixelColor(2, mosque2);
    strip.SetPixelColor(3, mosque2);
    strip.SetPixelColor(4, mosque2);
    // the following line demonstrates rgbw color support
    // if the NeoPixels are rgbw types the following line will compile
    // if the NeoPixels are anything else, the following line will give an error
    //strip.SetPixelColor(3, RgbwColor(colorSaturation));
    ...
    // strip.SetPixelColor(1, hslBlue);
    // strip.SetPixelColor(2, hslBlue);
    // strip.SetPixelColor(3, hslBlue);
